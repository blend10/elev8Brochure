...
!(function (t) {
  ...
  function (t, s, i) {
    ...
    t.exports = class {
      constructor(t, s) {
        (this.source = s),
          (this.A = new h(s.left, s.top)),
          (this.B = new h(s.right, s.top)),
          (this.C = new h(s.right, s.bottom)),
          (this.D = new h(s.left, s.bottom)),
          (this.Aleft = new h(s.left, s.top + s.height / 3)),
          (this.Atop = new h(s.left + s.width / 3, s.top)),
          (this.Btop = new h(s.right - s.width / 3, s.top)),
          (this.Bright = new h(s.right, s.top + s.height / 3)),
          (this.Cright = new h(s.right, s.bottom - s.height / 3)),
          (this.Cbottom = new h(s.right - s.width / 3, s.bottom)),
          (this.Dbottom = new h(s.left + s.width / 3, s.bottom)),
          (this.Dleft = new h(s.left, s.bottom - s.height / 3)),
          (this.ABx = 0),
          (this.ABy = 0),
          (this.CDx = 0),
          (this.CDy = 0),
  ...
  function (t, s) {
    t.exports = class {
      constructor(t = 0, s = 0) {
        ...
        let i = t || 0,
          h = s || 0;
        i && (i = parseInt(1e3 * i) / 1e3),
          h && (h = parseInt(1e3 * h) / 1e3),
          (this._props = [i, h]),
          (this[0] = i),
          (this[1] = h);
      }
  ...
  function (t, s, i) {
    ...
    t.exports = class {
      constructor(t) {
        (this.type = t.type || 0),
          (this.bend = t.bend || 0),
          (this.distortV = t.distortV || 0),
          (this.distortH = t.distortH || 0),
    ...
    var h = i(1),
      ...
      c = class {
        ...
        warp(t) {
          ...
          for (let t = 0; t < i.length; t++) {
            switch (i[t]) {
              case 'L':
                (i[t] = r),
                  (a = new h((2 * A[0] + o[C]) / 3, (2 * A[1] + o[C + 1]) / 3)),
                  (y = new h((A[0] + 2 * o[C]) / 3, (A[1] + 2 * o[C + 1]) / 3)),
                  (d = new h(o[C], o[C + 1])),
              ...
              case 'Q':
                (i[t] = r),
                  (a = new h((2 * o[C] + A.x) / 3, (2 * o[C + 1] + A.y) / 3)),
                  (y = new h(
                    (2 * o[C] + o[C + 2]) / 3,
                    (2 * o[C + 1] + o[C + 3]) / 3
                  )),
        ...
        calcRectangle() {
          ...
          return e.xMax == -1 / 0
            ? null
            : new o(e.xMin, e.yMin, e.xMax - e.xMin, e.yMax - e.yMin);
        }
      };
