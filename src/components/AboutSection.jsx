...
const StatCounter = ({ stat }) => {
  const { ref, inView } = useInView({
    triggerOnce: true, // trigger count up only once when scrolled into view
    threshold: 0.1,
  });
  ...
  return (
    <div
      ...
      ref={ref}
    >
      <div className="font-inter text-[#1E1E1E] text-[40px] md:text-[40px] xl:text-[80px] font-semibold leading-none tracking-tight xl:h-[80px]">
